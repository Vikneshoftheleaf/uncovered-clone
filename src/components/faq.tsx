export default function FAQ() {
    return (
        <>
            ...
            <section className="mt-12 max-w-6xl mx-auto grid grid-cols-6">
                <div className="col-span-2 space-y-4">
                    <h4 className="py-2 px-4 border text-xs border-gray-400 rounded-full inline-flex items-center gap-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-question" viewBox="0 0 16 16">
                    ...
                    <button className="py-2 px-4 border border-gray-400 rounded-full inline-flex items-center gap-1">Contact Us <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-arrow-right-short" viewBox="0 0 16 16">
                ...
                <div className="col-span-4">
                    ...
                    <div id="accordion-card" data-accordion="collapse">
                        <h2 id="accordion-card-heading-1">
                            <button type="button" className="border-gray-500 rounded-2xl flex items-center justify-between w-full p-4 font-medium rtl:text-right text-body shadow-xs border border-default hover:text-heading hover:bg-neutral-secondary-medium gap-3" data-accordion-target="#accordion-card-body-1" aria-expanded="true" aria-controls="accordion-card-body-1">
                                <span>How does the fractional Competitive Intelligence teammate work?</span>
                        ...
                        <div id="accordion-card-body-1" className="hidden border rounded-2xl border-gray-500 mt-1 shadow-xs" aria-labelledby="accordion-card-heading-1">
                        ...
                        <h2 id="accordion-card-heading-2" className="mt-4">
                            <button type="button" className="border-gray-500 rounded-2xl flex items-center justify-between w-full p-4 font-medium rtl:text-right text-body rounded-base shadow-xs border border-default hover:text-heading hover:bg-neutral-secondary-medium gap-3 " data-accordion-target="#accordion-card-body-2" aria-expanded="false" aria-controls="accordion-card-body-2">
                                <span>Do you have an affiliate program?</span>
                                <svg data-accordion-icon className="w-5 h-5 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 15 7-7 7 7" /></svg>
                            </button>
                        </h2>
                        <div id="accordion-card-body-2" className="hidden border rounded-2xl border-gray-500 mt-1 shadow-xs" aria-labelledby="accordion-card-heading-2">
                            <div className="p-4 md:p-5">
                        ...
                        <h2 id="accordion-card-heading-3" className="mt-4">
                            <button type="button" className="border-gray-500 rounded-2xl flex items-center justify-between w-full p-4 font-medium rtl:text-right text-body rounded-base shadow-xs border border-default hover:text-heading hover:bg-neutral-secondary-medium gap-3" data-accordion-target="#accordion-card-body-3" aria-expanded="false" aria-controls="accordion-card-body-3">
                                <span>What are the payment terms of the subscriptions?</span>
                                <svg data-accordion-icon className="w-5 h-5 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 15 7-7 7 7" /></svg>
                            </button>
                        </h2>
                        <div id="accordion-card-body-3" className="hidden  border rounded-2xl border-gray-500 mt-1 shadow-xs" aria-labelledby="accordion-card-heading-3">
                            <div className="p-4 md:p-5">
                        ...
                        <div id="accordion-card-body-4" className="hidden border rounded-2xl border-gray-500 mt-1 shadow-xs" aria-labelledby="accordion-card-heading-4">
                            <div className="p-4 md:p-5">
                                <p className="mb-2 text-body">The main difference is that the core components from Flowbite are open source under the MIT license, whereas Tailwind UI is a paid product. Another difference is that Flowbite relies on smaller and standalone components, whereas Tailwind UI offers sections of pages.</p>
                                <p className="mb-2 text-body">However, we actually recommend using both Flowbite, Flowbite Pro, and even Tailwind UI as there is no technical reason stopping you from using the best of two worlds.</p>
                                <p className="mb-2 text-body">Learn more about these technologies:</p>
