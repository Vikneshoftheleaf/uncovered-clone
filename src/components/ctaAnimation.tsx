    ...
    return (
        <>
            <section className="mt-12 max-w-6xl mx-auto flex flex-col items-center gap-4 p-6">
                <h4 className="py-2 px-4 border text-xs border-purple-500/20 rounded-full flex items-center gap-2"><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cloud-haze2" viewBox="0 0 16 16">
                ...
                <h1 className="lg:text-4xl text-2xl text-center font-bold">Multi-Channel: <br />Tens of thousand qualified data sources</h1>
                <h2 className="text-md text-center text-slate-400 font-semibold">Your Competitive Intelligence Platform</h2>
            </section>

            <section className="fade-mask relative overflow-hidden max-w-3xl mx-auto mt-4 flex flex-col gap-6 p-4">
                <Marquee autoFill loop={0} direction="left" >
                    <div className=" mx-8 p-4 rounded-2xl border border-purple-500/20">
                        <div className="p-4 border bg-gray-600/20 hover:bg-purple-500/50 transition-all duration-20 ease-in-out border-purple-500/20 rounded-2xl">
                ...
                <Marquee autoFill loop={0} direction="right" >
                    ...
                    <div className="mx-8 p-4 rounded-2xl border border-purple-500/20">
                        <div className="p-4 border bg-gray-600/20 border-purple-500/20 rounded-2xl">
